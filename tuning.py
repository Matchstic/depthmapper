# See: https://github.com/aryanvij02/StereoVision/blob/master/main_scripts/4_tuning_depthmap.py
...
if __name__ == '__main__':
    ...
    left_camera = open_capture(1, 640, 480)
    right_camera = open_capture(0, 640, 480)
    ...
    while True:
        ...
        if left_grabbed and right_grabbed:
            ...
            rectified_pair = calibrator.rectify(left_gray_frame, right_gray_frame)
