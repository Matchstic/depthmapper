...
CHESSBOARD_SQUARE_SIZE = 2.5

# Handles creation, saving and loading of calibration state for
# stereo cameras.
class Calibration:
    def __init__(self, width, height, load_directory, capture_directory = '/tmp/stereo/'):
        self.width = width
        self.height = height
    ...
    def capture_images(self):
        ...
        leftCapture = open_capture(1, self.width, self.height)    
        rightCapture = open_capture(0, self.width, self.height)
        ...
        for i in range (0, 30, 1):
            ...
            ret, frame1 = leftCapture.read()   
            ret, frame2 = rightCapture.read()
    ...
    def compute_calibration(self, show_results = False):
        ...
        calibrator = StereoCalibrator(CHESSBOARD_ROWS, CHESSBOARD_COLUMNS, CHESSBOARD_SQUARE_SIZE, (self.width, self.height))
